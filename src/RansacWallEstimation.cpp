...
void RansacWallEstimation::updateFeatureIntern(const base::samples::LaserScan& feature, const Eigen::Affine3d &featureInOdometry)
{
    ...
    {
        // add new feature
        sonarMap.addFeature(featureVector.front(), feature.start_angle + global_end_angle.getRad(), feature.time);
